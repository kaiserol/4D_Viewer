...
public final class CustomMenuItem extends CustomMenuBarNode {
    ...
    public CustomMenuItem(String text, ActionHandler actionHandler, ActionType actionType) {
        this(text, null, actionHandler, actionType);
    }
    ...
    private void setAction(ActionHandler actionHandler, ActionType actionType) {
        ...
        @SuppressWarnings("MagicConstant") KeyStroke primaryStroke = KeyStroke.getKeyStroke(primaryShortcut.getExtendedKeyCode(), primaryShortcut.getModifiersEx());
        ...
        if (shortcuts.size() > 1) {
            ...
            for (int i = 1; i < shortcuts.size(); i++) {
                ...
                @SuppressWarnings("MagicConstant") KeyStroke keyStroke = KeyStroke.getKeyStroke(shortcut.getExtendedKeyCode(), shortcut.getModifiersEx());
