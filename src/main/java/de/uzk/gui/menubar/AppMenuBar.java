...
public class AppMenuBar extends ObserverContainer<JMenuBar> {
    ...
    private CustomMenu getMenuEdit(ActionHandler actionHandler) {
        ...
        menuEdit.add(new CustomMenuItem(getWord("menu.edit.undo"), actionHandler, SHORTCUT_UNDO));
        menuEdit.add(new CustomMenuItem(getWord("menu.edit.redo"), actionHandler, SHORTCUT_REDO));
