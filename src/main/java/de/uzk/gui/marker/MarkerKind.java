...
public enum MarkerKind {
    SHAPE_RECTANGLE, SHAPE_ELLIPSE, SHAPE_TRIANGLE, ARROW, POINT_CROSS, POINT_ARROWHEAD, POINT_DOT;
    ...
    public Marker switchKind(Marker marker) {
        ...
        if(shape != null) {
            if (marker instanceof ShapeMarker gen) {
                ...
                return new ShapeMarker(rotatable, shape);
            }
            ...
            if(marker instanceof PointMarker point) {
                ...
                return new PointMarker(rotatable, pointMarkerShape);
            }
