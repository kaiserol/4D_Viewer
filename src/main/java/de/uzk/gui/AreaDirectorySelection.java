...
public class AreaDirectorySelection extends AreaContainerInteractive<JPanel> implements LoadingImageListener {
    ...
    private void startLoading() {
        ...
        this.loadingThread = new Thread(() -> {
            imageHandler.loadImageFiles(AreaDirectorySelection.this);
            closeLoadingDialog();
        });
