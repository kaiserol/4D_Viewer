...
public final class ActionUtils {
    ...
    public static final KeyEvent FIRST_IMAGE_LEVEL_ACTION = getKeyEvent(KeyEvent.VK_HOME, InputEvent.CTRL_DOWN_MASK);
    public static final KeyEvent LAST_IMAGE_LEVEL_ACTION = getKeyEvent(KeyEvent.VK_END, InputEvent.CTRL_DOWN_MASK);
